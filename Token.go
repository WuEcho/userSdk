...
func (_Token *TokenCaller) ERC712VERSION(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "ERC712_VERSION")
...
//
// Solidity: function ERC712_VERSION() view returns(string)
func (_Token *TokenSession) ERC712VERSION() (string, error) {
	return _Token.Contract.ERC712VERSION(&_Token.CallOpts)
}

// ERC712VERSION is a free data retrieval call binding the contract method 0x0f7e5970.
//
// Solidity: function ERC712_VERSION() view returns(string)
func (_Token *TokenCallerSession) ERC712VERSION() (string, error) {
	return _Token.Contract.ERC712VERSION(&_Token.CallOpts)
}
...
func (_Token *TokenCaller) PREDICATEROLE(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "PREDICATE_ROLE")
...
//
// Solidity: function PREDICATE_ROLE() view returns(bytes32)
func (_Token *TokenSession) PREDICATEROLE() ([32]byte, error) {
	return _Token.Contract.PREDICATEROLE(&_Token.CallOpts)
}

// PREDICATEROLE is a free data retrieval call binding the contract method 0xe72db5fd.
//
// Solidity: function PREDICATE_ROLE() view returns(bytes32)
func (_Token *TokenCallerSession) PREDICATEROLE() ([32]byte, error) {
	return _Token.Contract.PREDICATEROLE(&_Token.CallOpts)
}
...
func (_Token *TokenCaller) GetChainId(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "getChainId")
...
//
// Solidity: function getChainId() pure returns(uint256)
func (_Token *TokenSession) GetChainId() (*big.Int, error) {
	return _Token.Contract.GetChainId(&_Token.CallOpts)
}

// GetChainId is a free data retrieval call binding the contract method 0x3408e470.
//
// Solidity: function getChainId() pure returns(uint256)
func (_Token *TokenCallerSession) GetChainId() (*big.Int, error) {
	return _Token.Contract.GetChainId(&_Token.CallOpts)
}
...
func (_Token *TokenCaller) GetDomainSeperator(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "getDomainSeperator")
...
//
// Solidity: function getDomainSeperator() view returns(bytes32)
func (_Token *TokenSession) GetDomainSeperator() ([32]byte, error) {
	return _Token.Contract.GetDomainSeperator(&_Token.CallOpts)
}

// GetDomainSeperator is a free data retrieval call binding the contract method 0x20379ee5.
//
// Solidity: function getDomainSeperator() view returns(bytes32)
func (_Token *TokenCallerSession) GetDomainSeperator() ([32]byte, error) {
	return _Token.Contract.GetDomainSeperator(&_Token.CallOpts)
}
...
func (_Token *TokenCaller) GetNonce(opts *bind.CallOpts, user common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "getNonce", user)
...
//
// Solidity: function getNonce(address user) view returns(uint256 nonce)
func (_Token *TokenSession) GetNonce(user common.Address) (*big.Int, error) {
	return _Token.Contract.GetNonce(&_Token.CallOpts, user)
}

// GetNonce is a free data retrieval call binding the contract method 0x2d0335ab.
//
// Solidity: function getNonce(address user) view returns(uint256 nonce)
func (_Token *TokenCallerSession) GetNonce(user common.Address) (*big.Int, error) {
	return _Token.Contract.GetNonce(&_Token.CallOpts, user)
}
...
func (_Token *TokenTransactor) ExecuteMetaTransaction(opts *bind.TransactOpts, userAddress common.Address, functionSignature []byte, sigR [32]byte, sigS [32]byte, sigV uint8) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "executeMetaTransaction", userAddress, functionSignature, sigR, sigS, sigV)
}

// ExecuteMetaTransaction is a paid mutator transaction binding the contract method 0x0c53c51c.
//
// Solidity: function executeMetaTransaction(address userAddress, bytes functionSignature, bytes32 sigR, bytes32 sigS, uint8 sigV) payable returns(bytes)
func (_Token *TokenSession) ExecuteMetaTransaction(userAddress common.Address, functionSignature []byte, sigR [32]byte, sigS [32]byte, sigV uint8) (*types.Transaction, error) {
	return _Token.Contract.ExecuteMetaTransaction(&_Token.TransactOpts, userAddress, functionSignature, sigR, sigS, sigV)
}

// ExecuteMetaTransaction is a paid mutator transaction binding the contract method 0x0c53c51c.
//
// Solidity: function executeMetaTransaction(address userAddress, bytes functionSignature, bytes32 sigR, bytes32 sigS, uint8 sigV) payable returns(bytes)
func (_Token *TokenTransactorSession) ExecuteMetaTransaction(userAddress common.Address, functionSignature []byte, sigR [32]byte, sigS [32]byte, sigV uint8) (*types.Transaction, error) {
	return _Token.Contract.ExecuteMetaTransaction(&_Token.TransactOpts, userAddress, functionSignature, sigR, sigS, sigV)
}
...
// TokenMetaTransactionExecutedIterator is returned from FilterMetaTransactionExecuted and is used to iterate over the raw logs and unpacked data for MetaTransactionExecuted events raised by the Token contract.
type TokenMetaTransactionExecutedIterator struct {
	Event *TokenMetaTransactionExecuted // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenMetaTransactionExecutedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenMetaTransactionExecuted)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenMetaTransactionExecutedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenMetaTransactionExecutedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenMetaTransactionExecuted represents a MetaTransactionExecuted event raised by the Token contract.
type TokenMetaTransactionExecuted struct {
...
func (_Token *TokenFilterer) FilterMetaTransactionExecuted(opts *bind.FilterOpts) (*TokenMetaTransactionExecutedIterator, error) {

	logs, sub, err := _Token.contract.FilterLogs(opts, "MetaTransactionExecuted")
	if err != nil {
		return nil, err
	}
	return &TokenMetaTransactionExecutedIterator{contract: _Token.contract, event: "MetaTransactionExecuted", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event MetaTransactionExecuted(address userAddress, address relayerAddress, bytes functionSignature)
func (_Token *TokenFilterer) WatchMetaTransactionExecuted(opts *bind.WatchOpts, sink chan<- *TokenMetaTransactionExecuted) (event.Subscription, error) {

	logs, sub, err := _Token.contract.WatchLogs(opts, "MetaTransactionExecuted")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenMetaTransactionExecuted)
				if err := _Token.contract.UnpackLog(event, "MetaTransactionExecuted", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event MetaTransactionExecuted(address userAddress, address relayerAddress, bytes functionSignature)
func (_Token *TokenFilterer) ParseMetaTransactionExecuted(log types.Log) (*TokenMetaTransactionExecuted, error) {
	event := new(TokenMetaTransactionExecuted)
	if err := _Token.contract.UnpackLog(event, "MetaTransactionExecuted", log); err != nil {
		return nil, err
	}
